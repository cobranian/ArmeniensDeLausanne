...
(function () {
  ...
  var dict = {
    fr: {
      ...
      "culture.painters.title": "Trois peintres, <em>trois lumières</em>",
      "culture.painters.lead": "Le feu de Minas Avetisyan, le silence des figures de Movses Poghosyan, la lumière des hauts plateaux d'Armen Harutyunyan « Lorenc » — une même terre, traduite trois fois en couleur.",
    ...
    en: {
      ...
      "culture.painters.title": "Three painters, <em>three lights</em>",
      "culture.painters.lead": "The fire of Minas Avetisyan, the silence of Movses Poghosyan's figures, the light of the highlands by Armen Harutyunyan « Lorenc » — one land, rendered three times in colour.",
    ...
    hy: {
      ...
      "culture.painters.title": "Երեք նկարիչ՝ <em>երեք լույս</em>",
      "culture.painters.lead": "Մինաս Ավետիսյանի կրակը, Մովսես Պողոսյանի կերպարների լռությունը, Արմեն Հարությունյանի՝ «Լորենց»-ի բարձրավանդակների լույսը — մեկ հող՝ երեք անգամ թարգմանված գույնով։",
