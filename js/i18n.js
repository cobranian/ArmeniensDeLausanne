...
(function () {
  ...
  var dict = {
    fr: {
      ...
      "culture.painters.title": "Cinq peintres, <em>cinq regards</em>",
      "culture.painters.lead": "Le feu de Minas Avetisyan, le silence de Movses Poghosyan, la lumière d'Armen Harutyunyan « Lorenc », la grâce de Matevos Sargsyan et la floraison de Shahen Ordubekyan — une même terre, traduite en couleur.",
    ...
    en: {
      ...
      "culture.painters.title": "Five painters, <em>five gazes</em>",
      "culture.painters.lead": "The fire of Minas Avetisyan, the silence of Movses Poghosyan, the light of Armen Harutyunyan « Lorenc », the grace of Matevos Sargsyan and the bloom of Shahen Ordubekyan — one land, rendered in colour.",
    ...
    hy: {
      ...
      "culture.painters.title": "Հինգ նկարիչ՝ <em>հինգ հայացք</em>",
      "culture.painters.lead": "Մինաս Ավետիսյանի կրակը, Մովսես Պողոսյանի լռությունը, Արմեն Հարությունյան «Լորենց»-ի լույսը, Մատևոս Սարգսյանի շնորհը և Շահեն Օրդուբեկյանի ծաղկումը — մեկ հող՝ թարգմանված գույնով։",
